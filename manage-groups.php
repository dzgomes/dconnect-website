...
<?php
	...
	if ($_SESSION['userStatus'] == 1) {
  	header('Location:  tutor.php');
        ...
        $query = "SELECT g.groupID, G.groupName, G.groupDescription, G.groupLocation, G.groupSubject, G.groupTime FROM groupInfo G JOIN groupList L ON G.groupID = L.groupID JOIN users U ON U.userID = L.userID";
...
<head>
    ...
    <div class="middle-section"> 
        ...
        <div class="middle-column">
			...
			echo "</td>";        
			echo "<td>";
			echo "<form action=leave-group.php method=post>
                          <p><input type=submit name=submit value=Leave></p>
                        </form>"; 
